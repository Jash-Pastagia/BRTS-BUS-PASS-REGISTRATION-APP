 ...
 <div class="panel panel-default">
    ...
    // $db = mysqli_select_db($connection,'admin');
            ...
            if(isset($_POST['submit']))
            {
                ...
                $q1 = "select * from u_detail where u_doc_status=1 AND  eligible=0 AND u_timeslotdate BETWEEN '$datefrom' AND '$dateto' ";
            }
            else{
                $q1="select * from u_detail where u_doc_status=1 AND  eligible=0 ";
            }
